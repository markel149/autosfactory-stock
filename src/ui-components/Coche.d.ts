...
export declare type CocheInputValues = {
    marca?: string;
    modelo?: string;
    matricula?: string;
    color?: string;
...
export declare type CocheValidationValues = {
...
export declare type CocheOverridesProps = {
    CocheGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type CocheProps = React.PropsWithChildren<{
    overrides?: CocheOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: CocheInputValues) => CocheInputValues;
    onSuccess?: (fields: CocheInputValues) => void;
    onError?: (fields: CocheInputValues, errorMessage: string) => void;
    onChange?: (fields: CocheInputValues) => CocheInputValues;
    onValidate?: CocheValidationValues;
} & React.CSSProperties>;
export default function Coche(props: CocheProps): React.ReactElement;
